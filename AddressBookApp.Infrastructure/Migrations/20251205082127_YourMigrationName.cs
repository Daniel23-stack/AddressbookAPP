        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuickNotes = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsClient = table.Column<bool>(type: "bit", nullable: false),
                    IsImported = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ImportedById = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApiUsages_ApiClients_ApiClientId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactActivities_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactPhotos_Users_UploadedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ContactTags_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomFieldDefinitions_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactGroupContacts", x => new { x.ContactsId, x.GroupsId });
                    table.ForeignKey(
                        name: "FK_ContactGroupContacts_ContactGroups_GroupsId",
                        column: x => x.GroupsId,
                        principalTable: "ContactGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactGroupContacts_Contacts_ContactsId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ContactTagContacts", x => new { x.ContactsId, x.TagsId });
                    table.ForeignKey(
                        name: "FK_ContactTagContacts_ContactTags_TagsId",
                        column: x => x.TagsId,
                        principalTable: "ContactTags",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ContactTagContacts_Contacts_ContactsId",
                        column: x => x.ContactsId,
                        principalTable: "Contacts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApiUsages_ApiClientId",
                table: "ApiUsages",
                column: "ApiClientId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactActivities_ContactId_Timestamp",
                table: "ContactActivities",
                columns: new[] { "ContactId", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_ContactActivities_UserId",
                table: "ContactActivities",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactGroupContacts_GroupsId",
                table: "ContactGroupContacts",
                column: "GroupsId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactGroups_Name_UserId",
                table: "ContactGroups",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ContactPhotos_UploadedById",
                table: "ContactPhotos",
                column: "UploadedById");

            migrationBuilder.CreateIndex(
                name: "IX_ContactTagContacts_TagsId",
                table: "ContactTagContacts",
                column: "TagsId");

            migrationBuilder.CreateIndex(
                name: "IX_ContactTags_Name_UserId",
                table: "ContactTags",
                columns: new[] { "Name", "UserId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomFieldDefinitions_Name_UserId",
                table: "CustomFieldDefinitions",
                columns: new[] { "Name", "UserId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CustomFieldDefinitions_UserId",
                table: "CustomFieldDefinitions",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedSearches_Name_UserId",
                table: "SavedSearches",
                columns: new[] { "Name", "UserId" },
                unique: true);
